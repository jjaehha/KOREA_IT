...
const MapTestPage9 = () => {
    ...
    useEffect(() => {
        axios
            .all([
                axios.get(
                    `http://openapi.seoul.go.kr:8088/576e61714e636a6b3637545a455046/json/TvEmgcHospitalInfo/1/${dataCnt.hos}/`
                ),
                axios.get(
                    `http://openapi.seoul.go.kr:8088/4f49455041636a6b37376d485a5255/json/SeoulPublicLibraryInfo/1/${dataCnt.lib}/`
                ),
            ])
            .then(
        ...
        hos.forEach((elem) => {
            ...
            geocoder.addressSearch(addr, (result, status) => {
                ...
                if (status === kakao.maps.services.Status.OK) {
                    ...
                    if (markersContent.length === dataCnt.hos) {
